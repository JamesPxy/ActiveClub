...
import com.pxy.recyclerbaner.adapter.BaseBannerAdapter;
...
public abstract class RecyclerBannerBase<L extends RecyclerView.LayoutManager, A extends BaseBannerAdapter> extends FrameLayout {
    ...
    public RecyclerBannerBase(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RecyclerBannerBase(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            unSelectedGradientDrawable.setColor(getColor(android.R.color.black));
        ...
        indicatorMargin = a.getDimensionPixelSize(R.styleable.RecyclerBanner_indicatorSpace, dp2px(4));
        int marginLeft = a.getDimensionPixelSize(R.styleable.RecyclerBanner_indicatorMarginLeft, dp2px(16));
        int marginRight = a.getDimensionPixelSize(R.styleable.RecyclerBanner_indicatorMarginRight, dp2px(0));
        int marginBottom = a.getDimensionPixelSize(R.styleable.RecyclerBanner_indicatorMarginBottom, dp2px(11));
        int g = a.getInt(R.styleable.RecyclerBanner_indicatorGravity, 0);
        int gravity;
        if (g == 0) {
...
//        params.gravity = Gravity.BOTTOM | gravity;
        ...
        if (LinearLayoutManager.VERTICAL == orientation) {
            if (Gravity.CENTER == gravity) gravity = GravityCompat.START;
            params.gravity = Gravity.CENTER | gravity;
        } else {
            params.gravity = Gravity.BOTTOM | gravity;
        }
