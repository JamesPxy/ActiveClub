...
import com.pxy.recyclerbaner.adapter.RecyclerAdapterNormal;
 ...
 * @Description 普通轮播组件
 */
public class RecyclerBannerNormal extends RecyclerBannerBase<LinearLayoutManager, RecyclerAdapterNormal> {

    public RecyclerBannerNormal(Context context) {
        this(context, null);
    }

    public RecyclerBannerNormal(Context context, AttributeSet attrs) {
